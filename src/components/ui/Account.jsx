...
function Account() {
    return (
        <div className="bg-card flex-1 flex flex-col items-center rounded-xl shadow-md p-8">
            <div className="profile pb-1 border-b border-b-border border-opacity-10 w-full flex flex-col items-center pt-3 gap-3">
                <div className="photo w-32">
                    <img src="https://pbs.twimg.com/media/FjU2lkcWYAgNG6d.jpg" alt="" className="w-full rounded-xl"/>
                </div>
